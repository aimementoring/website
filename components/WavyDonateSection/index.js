    ...
    >
      <svg className={styles.frameSvg} viewBox="0 0 108.6 14.8" preserveAspectRatio="xMinYMid meet">
        ...
        <g className={styles.donateSvgGroup}>
          ...
          <path id="donateBottomPath" d="M-45.4 12.3c13.9-.6 13.1-5.8 24.7-5.8s12.8 5.4 24.6 5.8c11.8.4 12.5-5.8 25.2-5.8s12.6 5.8 25 5.8 12.5-5.8 24.7-5.8 12.4 5.7 24.9 5.8h4.2" />
