  ...
  <div className={styles.beAMentorFormWrapper}>
    ...
    <div className={styles.mentorNotification}>
      ...
      <Paragraph>
        Please note that&nbsp;
        <mark>
          due to COVID-19 at this stage we are pausing the delivery of our physical programs until&nbsp;
      ...
      <Paragraph>
      You can still sign up but we won&apos;t be processing applications and our teams won&apos;t be conducting interviews until further notice. Our attention will be on taking our program digital with the launch of a daily mentoring TV show IMAGI-NATION starting Monday 23 March - we&apos;d love you to&nbsp;
