export const GLOBAL_TAGS = {
  ...
  openGraph: {
    type: 'website',
    description: 'We build mentoring bridges between the powerful and the powerless and we are driven to unlock the limitless potential of children who have been left behind.',
    locale: 'en_001',
    images: [{
      width: 1200,
      height: 630,
      url: 'https://d2ylaz7bdw65jx.cloudfront.net/resources/_1200x630_crop_center-center_82_none/social_share.jpg', // 1 EXCEPTION (/jack-manning-bancroft)
    }],
  },
  twitter: {
    site: '@aimementoring',
    ...
    image: {
      url: 'https://d2ylaz7bdw65jx.cloudfront.net/resources/social_share.jpg', // 1 EXCEPTIONS (/jack-manning-bancroft)
      width: 1200, // 1 EXCEPTIONS (/jack-manning-bancroft)
