  ...
  withCSS(
    withSass({
      ...
      env: {
        ...
        REACT_APP_CONTENTFUL_API_KEY_STAGING: process.env.REACT_APP_CONTENTFUL_API_KEY_STAGING,
        REACT_APP_CONTENTFUL_API_KEY_MASTER: process.env.REACT_APP_CONTENTFUL_API_KEY_MASTER,
