  ...
  withCSS(
    withSass({
      ...
      env: {
        ...
        REACT_APP_CONTENTFUL_CONTENT_TYPE: process.env.REACT_APP_CONTENTFUL_CONTENT_TYPE,
        REACT_APP_CONTENTFUL_ENTRY_KEY: process.env.REACT_APP_CONTENTFUL_ENTRY_KEY,
