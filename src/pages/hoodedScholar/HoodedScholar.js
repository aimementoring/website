...
class HoodedScholar extends PureComponent {
  ...
  componentDidMount() {
    this.setState({ hasMounted: true, assetsUrl: getAssetsBaseUrl() });
  }

  componentWillReceiveProps(nextProps) {
    this.handleScrollToRegister(nextProps.location.hash);
    this.handleScrollToHow(nextProps.location.hash);
  }

  handleScrollToHow = locationHash => {
    if (locationHash === '#how') {
      this.scrollToHowSection();
    }
  };

  handleScrollToRegister = locationHash => {
    if (locationHash === '#register') {
      this.scrollToRegisterSection();
    }
  };

  // scrollToRegisterSection = () => {
  //   scrollToComponent(this.sectionRefs.register, { offset: -110, align: 'top' });
  // };
  ...
  render() {
    ...
    const { assetsUrl, hasMounted } = this.state;
    return (
      <div>
        {!hasMounted ? (
          <div />
                        ...
                        <div className="px1 center m3 mx-auto">
                          <h1 className="px1 pb2 center">
                            ...
                            <span className="pre-text block light f-24 feature-font-family left-align right">
                              &nbsp; &nbsp; Hooded Scholars are now on the
                              ground <br />
                          ...
                          <div className="hero-panel-video-button video-button">
                            ...
                            <h3>
                              <span className="text-highlight f-14">
                                Watch the recap
                              </span>
                            </h3>
                          </div>
                  ...
                  <div className="hs-info-grid py4">
                    <div className="area-heading mx-auto pt2 pb4">
                      <h1 className="c-white section-intro-heading">
                        This <br />
                        was <br />
                        the <strong>Hooded Hustle</strong>
                      </h1>
                      <span
                    ...
                    <div className="area-info mx-auto pt3">
                      <div className="info-content-wrapper">
                        ...
                        <p className="c-white">
                          Last year, for the first time ever, AIME offered 200
                          US college &amp; university students the chance to
                          become{' '}
                          <strong className="c-cmyk-pink">
                            "The Hooded Scholar"
                          </strong>{' '}
                          and lead a mentoring movement out of their campus to
                          lift kids out of inequality.
                        </p>
                        <p className="c-white">
                          It was a chance for these students to arrest some
                          control over the future of their world, and to create
                          a fairer planet together.
                        </p>
                        <p className="c-white">
                          Each Hooded Scholarship was{' '}
                          <strong className="c-cmyk-yellow">
                            valued at over $50k
                          </strong>{' '}
                          and included
                          <strong className="c-cmyk-pink">
                          ...
                          . The impact each of these Hooded Scholars now hold,
                          is priceless! Check out the promo video of our CEO
                          &amp; Founder, Jack, sharing why this opportunity was
                          made available, and will continue to be made available
                ...
                <div className="wrap section-hoodedScholar pt2 pb4 flex flex-row flex-wrap">
                  <div className="section-hoodedScholar-column sm-col-12 md-col-9 mx-auto px2">
                    <div className="sm-col sm-col-12 clearfix pt3">
                      <h4 className="highlight-text sm-col-8 sml-rotate">
                        Do you want in?
                      </h4>
                      <h5 className="sm-col sm-col-12 md-col-8 c-white pt2 pb3">
                        We're not recruiting for Hooded Scholars right now, but
                        time flies and it won't be long until we're on the hunt
                        again. If you're keen to express your interest in
                        applying for our 2020 intake, fill in your details below
                        and we’ll email you when applications are open again.{' '}
                      </h5>
                    </div>
                    <HoodedScholarForm
                      history={history}
                      uploadData={uploadHoodedScholarEOI}
                    />
                  </div>
                </div>
              </section>
