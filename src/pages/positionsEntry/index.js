...
import { getCountrySite } from '../../utils/utilities';
...
export default class PositionsEntry extends PureComponent {
  ...
  setRequiredDocuments = ({ requiredDocuments }) => {
    ...
    const elements = this.transformTemplate(
  ...
  handleFieldChange = propertyValue => e => {
    const newValue = e.target.value;
    this.setState({ [propertyValue]: newValue });
  };

  createJobPacks = ({ jobPacks }) => {
  ...
  transformTemplate = (container, quantity) => {
    ...
    return [...new Array(quantity)]
      ...
      .map(t => {
        return parser.parseFromString(t, 'text/html').firstChild.querySelector('body').firstChild;
      });
  };
  ...
  render() {
    ...
    if (isNaN(embedVideoId)) embedVideoId = false;
    const header = (
        ...
        <div id="positions-entry">
          ...
          >
            ...
            <div className="block f-14 light js-non-unavailable-position c-black">
              ...
              {location && <p className="inline-block px1 js-job-dash-location">-</p>}
              <p className="inline-block js-job-term">{job.term}</p>
              {job.salaryRange && <p className="inline-block px1 js-job-dash-location">-</p>}
              {job.salaryRange && <p className="inline-block js-job-expires">{job.salaryRange}</p>}
            </div>
            ...
            <div className={`mb4 js-video-container ${id !== 'recqdjbXEa2ipFqlR' ? 'hide' : ''}`}>
              {embedVideoId && (
                <div className="js-job-embed-videos video-container" style={{ paddingTop: '0' }}>
                  <iframe
            ...
            {!hideDocsContainer ? (
              <div className="js-job-packs block mb3 md-mb4 lg-mb4">
                <script type="text/template">
                  <a href="/" target="_blank" className="bold c-grey feature-font-family text-decoration-none flex mb2 mr4 truncate">
                    <i className="material-icons mr2">file_download</i>
                    <span className="js-job-packs-filename truncate">filename</span>
                  </a>
                </script>
                <h4 className="mb1 feature-font-family regular c-brand-primary">Supporting Docs</h4>
              ...
              {showForm && Object.keys(job).length > 0 && (
                ...
                >
                  ...
                  >
                    ...
                    <input type="hidden" name="submissionmessage" value="jobs" />
                    <input
                      type="hidden"
                      name="job_type"
                      ...
                      <div>
                        {locationError && (
                          <p className="error-message">
                            Oh no! Sorry looks like we’re not accepting applications from this
                            country yet
                          </p>
                        )}
                      </div>
                    ...
                    <div className="sm-col sm-col-6 md-col-6 o7-r o7-b">
                      <input
                        ...
                        name="street_number"
                        value={streetNumber}
                        onChange={this.handleFieldChange('streetNumber')}
                      />
                    </div>
                    ...
                    <div className="sm-col sm-col-12 md-col-12 o7-r o7-b">
                      <input
                        ...
                        name="street_name"
                        value={streetName}
                        onChange={this.handleFieldChange('streetName')}
                        required
                      />
                    </div>
                    ...
                    <div className="sm-col sm-col-6 md-col-6 o7-r o7-b">
                      <input
                        ...
                        name="state"
                        value={territory}
                        onChange={this.handleFieldChange('territory')}
                        required
                      />
                    </div>
                    ...
                    <div className="sm-col sm-col-6 md-col-6 o7-r o7-b">
                      ...
                      >
                        ...
                        <option value="AIME Friends Email">AIME Friends Email</option>
                        <option value="AIME Website">AIME Website</option>
                        <option value="During an AIME Session">During an AIME Session</option>
                        <option value="Ethical Positions">Ethical Positions</option>
                    ...
                    <div className="clearfix my3 sm-col sm-col-12 md-col-12 js-job-documents">
                      ...
                      <p className="f-14 light pb2">
                        We need the below documents to proceed with your application.
                      </p>

                      <div className="flex flex-column items-start job-documents js-job-document-container">
                        <script type="text/template" className="js-job-document">
                          <label>
                            <div
                              className="upload-field mb2"
                              data-api-key={process.env.REACT_APP_FILE_UPLOADER_API_KEY}
                            />
                          </label>
                        </script>
                      </div>
                    ...
                    <div>
                      {job.country.toLowerCase().includes('australia') && (
                        <div className="sm-col sm-col-12 md-col-12 f-14 pt1 pb1 flex items-center custom-checkbox custom-checkbox--default">
                          ...
                          <input id="indigenous" type="checkbox" className="hide" name="indigenous" value="yes" />
                          <label htmlFor="indigenous">I identify as an Aboriginal and/or Torres Strait Islander person.</label>
                        </div>
                      )}
                    </div>

                    <div className="sm-col sm-col-12 md-col-12 f-14 pt1 pb3 flex items-center custom-checkbox custom-checkbox--default">
                      <input type="hidden" name="be-an-aime-friend" value="no" />
                      <input
                        id="aime-friend"
                        type="checkbox"
                        className="hide"
                      ...
                      <label htmlFor="aime-friend">
                        Become an AIME Friend. Recieve updates about AIME and help us tackle
                        inequality.
                      </label>
                    </div>
            ...
            <Link to="/positions#opportunity-list" className="article-tile-link basic-btn italic">
