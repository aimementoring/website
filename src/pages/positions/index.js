  ...
  useEffect(() => {
    ...
    _.forEach(tabs, (tab, index) => {
      tab.addEventListener('click', e => {
        e.preventDefault();
        _.forEach(tabs, t => t.classList.remove('active'));
        tab.classList.add('active');

        _.forEach(tabContents, t => t.classList.remove('active'));
    ...
    <div className="positions">
      ...
      <section className="relative">
            ...
            <div className="job-tabs-content job-tabs-content--life justify-between items-center mt2 mb4 col-12 active">
              ...
              <div className="scratch-bg video-button grid-tile">
                ...
                <div
                  ...
                  style={{
                    backgroundImage: `url('${assetsUrl}/assets/images/square-features/Student-min.jpg')`,
                      ...
                      <div className="flex flex-column col-12 pr0 pb3 md-pb4 lg-pb4 border-box sm-col-6 sm-pr3 md-col-3 lg-col-3 md-pr3 lg-pr3">
                        <div
                          style={{
                            width: '100px',
                            height: '100px',
                            backgroundImage: `url('${assetsUrl}/assets/images/job-perks-icons/annual-increase.svg')`,
                        ...
                        <p className="body-font-family">
                          Each role receives a 4% salary increase annually, with an expectation that
                      ...
                      <div className="flex flex-column col-12 pr0 pb3 md-pb4 lg-pb4 border-box sm-col-6 md-col-3 lg-col-3 md-pr3 lg-pr3">
                        <div
                          style={{
                            width: '100px',
                            height: '100px',
                            backgroundImage: `url('${assetsUrl}/assets/images/job-perks-icons/discount.svg')`,
                            backgroundSize: 'contain',
                            backgroundRepeat: 'no-repeat',
                            backgroundPosition: 'center',
                          }}
                      ...
                      <div className="flex flex-column col-12 pr0 pb3 md-pb4 lg-pb4 border-box sm-col-6 sm-pr3 md-col-3 lg-col-3 md-pr3 lg-pr3">
                        <div
                          style={{
                            width: '100px',
                            height: '100px',
                            backgroundImage: `url('${assetsUrl}/assets/images/job-perks-icons/baby.svg')`,
                            backgroundSize: 'contain',
                            backgroundRepeat: 'no-repeat',
                            backgroundPosition: 'center',
                          }}
                        ...
                        <p className="body-font-family">
                          Wanna have a baby at AIME? Cool. Do it. You get 2 weeks per year worth of
                          paid parental leave in your first 2 years of parenthood. And the option to
                          work from home in flexible work arrangement in the first 2 years.
                        </p>
                      </div>
                      <div className="flex flex-column col-12 pr0 pb3 md-pb4 lg-pb4 border-box sm-col-6 md-col-3 lg-col-3 md-pr3 lg-pr3">
                        <div
                          style={{
                            width: '100px',
                            height: '100px',
                            backgroundImage: `url('${assetsUrl}/assets/images/job-perks-icons/extra-leave.svg')`,
                            backgroundSize: 'contain',
                            backgroundRepeat: 'no-repeat',
                            backgroundPosition: 'center',
                          }}
                        ...
                        <p className="body-font-family">
                          5 days of study and development leave per annum. 3 days worth of cultural
                          leave. Also, 1 day of legend leave to volunteer for another cause.
                        </p>
                      </div>
                      <div className="flex flex-column col-12 pr0 pb3 md-pb4 lg-pb4 border-box sm-col-6 sm-pr3 md-col-3 lg-col-3 md-pr3 lg-pr3">
                        <div
                          style={{
                            width: '100px',
                            height: '100px',
                            backgroundImage: `url('${assetsUrl}/assets/images/job-perks-icons/health.svg')`,
                            backgroundSize: 'contain',
                            backgroundRepeat: 'no-repeat',
                            backgroundPosition: 'center',
                          }}
                        ...
                        <p className="body-font-family">
                          ...
                          where you have to go to nature for at least an hour, to take stock of your
                          mental health, and rock fluro gear to be a beacon of openness to others.
                        </p>
                      </div>
                      <div className="flex flex-column col-12 pr0 pb3 md-pb4 lg-pb4 border-box sm-col-6 md-col-3 lg-col-3 md-pr3 lg-pr3">
                        <div
                          style={{
                            width: '100px',
                            height: '100px',
                            backgroundImage: `url('${assetsUrl}/assets/images/job-perks-icons/interaction.svg')`,
                            backgroundSize: 'contain',
                            backgroundRepeat: 'no-repeat',
                            backgroundPosition: 'center',
                          }}
                      ...
                      <div className="flex flex-column col-12 pr0 pb3 md-pb4 lg-pb4 border-box sm-col-6 sm-pr3 md-col-3 lg-col-3 md-pr3 lg-pr3">
                        <div
                          style={{
                            width: '100px',
                            height: '100px',
                            backgroundImage: `url('${assetsUrl}/assets/images/job-perks-icons/learning.svg')`,
                            backgroundSize: 'contain',
                            backgroundRepeat: 'no-repeat',
                            backgroundPosition: 'center',
                          }}
                      ...
                      <div className="flex flex-column col-12 pr0 pb3 md-pb4 lg-pb4 border-box sm-col-6 md-col-3 lg-col-3 md-pr3 lg-pr3">
                        <div
                          style={{
                            width: '100px',
                            height: '100px',
                            backgroundImage: `url('${assetsUrl}/assets/images/job-perks-icons/salary-sacrifice.svg')`,
                            backgroundSize: 'contain',
                            backgroundRepeat: 'no-repeat',
                            backgroundPosition: 'center',
                          }}
                        ...
                        <p className="body-font-family">
                          With AIME you can salary sacrifice which means you can clip off a section
                          of your salary tax free — more cash in your pocket.
                        </p>
                      </div>
                    </div>
                  </div>
            ...
            <div className="job-tabs-content mt2 mb4 col-12 clearfix">
              <div className="flex items-start w100">
                <div className="mb2 w100">
                  ...
                  <p className="f-16 light c-grey block pt0 md-pt1 lg-pt1">
                    This salary table should help guide current and prospective staff around whether
                    this value package lines up with your respective expectations and desires.
                    Please note this table is a guide only and more specific information can be
                    found in the Job Packs for each position. Amounts are inclusive of Super.
                  </p>
        ...
        <div
          ...
          style={{
            backgroundImage: `url('${assetsUrl}/assets/images/banner/endorsement-video.png')`,
          }}
        >
