          ...
          <section className={styles.sectionAbout}>
            <div className={styles.column}>
              ...
              <div className={styles.copy}>
                ...
                <Link to="/know-aime" className={styles.linkButton}>
                  Tell me more
                </Link>
              </div>
            </div>
            <div className={styles.column}>
              <img
                ...
                src={`${assetsUrl}/assets/images/about/about-aime.jpg`}
                alt="about aime"
              />
            </div>
          </section>
          <section className={styles.sectionAbout}>
            ...
            <div className={styles.column}>
              <img
                className={styles.imageBlock}
                alt="kids at aime"
                src={`${assetsUrl}/assets/images/about/the-kids-at-aime.jpg`}
              />
            </div>
          </section>
          <section className={styles.sectionAbout}>
            <div className={styles.column}>
              ...
              <div className={styles.copy}>
                ...
                <Link to="/impact" className={styles.linkButton}>
                  Read more
                </Link>
              </div>
            </div>
            <div className={styles.column}>
              <img
                className={styles.imageBlock}
                alt="impact"
                src={`${assetsUrl}/assets/images/about/impact.jpg`}
              />
            </div>
          </section>
          <section className={styles.sectionAbout}>
            ...
            <div className={styles.column}>
              <img
                ...
                src={`${assetsUrl}/assets/images/about/gift-of-knowladge.jpg`}
              />
            </div>
          </section>
          <section className={styles.sectionAbout}>
            <div className={styles.column}>
              ...
              <div className={styles.copy}>
                ...
                <Link to="/positions" className={styles.positionsButton}>
                  Join our team
                </Link>
              </div>
            </div>
            <div className={styles.column}>
              <img
                className={styles.imageBlock}
                alt="team"
                src={`${assetsUrl}/assets/images/about/team.jpg`}
              />
            </div>
          </section>
          <section className={styles.sectionAbout}>
            ...
            <div className={styles.column}>
              <img
                className={styles.imageBlock}
                alt="hoodie"
                src={`${assetsUrl}/assets/images/about/hoodie.jpg`}
              />
            </div>
          </section>
        </div>
