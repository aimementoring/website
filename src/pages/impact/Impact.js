                ...
                <div className="vid-container">
                  ...
                  <div className="bgVideo-container">
                    <video autoPlay muted loop preload="true" id="bgVideo">
                      <source
                        src={`${assetsUrl}/assets/media/PURPLE_SMOKE_BACKGROUND.webm`}
                        type="video/webm"
                      />
                      <source
                        src={`${assetsUrl}/assets/media/PURPLE_SMOKE_BACKGROUND.mp4`}
                        type="video/mp4"
                      />
                    </video>
                  </div>
            ...
            <div className="wrap items-center lg-px4 lg-pb4 lg-pt0">
              <h2 className="xs-p1 sm-p2 md-p4 lg-p4 center">
                <span className="f-24 feature-font-family">
                  We’ve got a story of change that’s lit up the world since
                  2005, one kid at a time. It’s a simple idea, mentoring.
                  <br /> <br />
                  It’s a{' '}
                  <span className="text-highlight purple">
                    <a href="#panel4"> proven model</a>
                  </span>{' '}
                  to end inequality and bring the powerful and powerless
                  together, cost-effectively and at scale.
                </span>
              </h2>
            </div>
          </section>
              ...
              <section className="section-about">
                <div className="section-about__column p2 xs-p1 items-center">
                  <div className="section-about__copy lg-col-8">
                    <h3 className="c-white my2">
                      We’ve ended educational inequality
                    </h3>
                    <p className="c-white">
                      We do that by building mentoring bridges between
                      universities and high schools, between the powerful and
                      the powerless, the haves and the have nots. We know that
                      our fiery and intuitive brand of mentoring ends the cycle
                      of disadvantage by permanently changing mindsets. Based in
                      Redfern, Australia, our operation runs across campuses
                      worldwide.
                    </p>
                  </div>
                </div>
                <div
                  className="section-about__column p2"
                  style={{ alignItems: 'flex-end' }}
                >
                  <img
                    className="block"
                    src={`${assetsUrl}/assets/images/impact/edu.png`}
                    alt="about aime"
                  />
                </div>
              </section>
              <section className="section-about">
                <div className="section-about__column p2">
                  <div className="section-about__copy lg-col-8">
                    ...
                    <p className="c-white">
                      As at 2018, every $ spent on AIME, $9 worth of benefits
                      are generated for the society.{' '}
                    </p>
                  </div>
                </div>
                <div
                ...
                >
                  <img
                    className="block"
                    src={`${assetsUrl}/assets/images/impact/cost.png`}
                    alt="about aime"
                  />
                </div>
              </section>
              <section className="section-about">
                <div className="section-about__column p2">
                  <div className="section-about__copy lg-col-8">
                    ...
                    <p className="c-white">
                      What started as a simple idea working with 25 mentees at
                      the University of Sydney is now a global movement of
                      change through mentoring, fueled by university students,
                      and the model is set for rapid expansion till 2025.
                    </p>
                  </div>
                </div>
                <div
                ...
                >
                  <img
                    className="block"
                    src={`${assetsUrl}/assets/images/impact/scale.png`}
                    alt="about aime"
                  />
                </div>
              </section>
          ...
          <section className="section-impact bg-lavender-light" id="panel4">
            <div className="wrap xs-p3 sm-p2 md-p4 lg-p4">
              <div className="flex flex-row flex-wrap justify-between pb2">
                <div>
                  <h2 className="f-24 feature-font-family">
                ...
                <div className="buttons-container right">
                  <Link
                    to="/reports"
                    className="ghost-btn ghost-btn-alt bg-brand-primary mb2"
                  >
              ...
              <div className="main-grid">
                <div className="tile">
                  <div className="">
                    <a href="https://www.dropbox.com/s/1uxaohjfrtaled7/Economic%20Evaluation%20of%20AIME%20Mentoring%20by%20KPMG.pdf?dl=0">
                      <div
                        ...
                        style={{
                          backgroundImage: `url('${assetsUrl}/assets/images/impact/kpmg-ecom.jpg')`,
                  ...
                  <div className="">
                    ...
                    <p className="tile-copy">
                      This evaluation by KPMG shows that AIME returns $8 back
                      into the economy for every $1 invested, and most
                      importantly the program has literally closed the education
                      gap for 10,000+ Indigenous Australian kids who have been
                      through it
                    </p>
                  </div>
                </div>
                <div className="tile">
                  <div className="">
                    <a href="global-letter" target="_blank">
                      <div
                        className="flex items-center video-button rounded"
                        style={{
                          backgroundImage: `url('${assetsUrl}/resources/no-shame.jpg')`,
                          backgroundSize: 'cover',
                          width: '100%'
                        }}
                      >
                  ...
                  <div className="">
                    ...
                    <p className="tile-copy">
                      An open letter from University & business leaders across
                      Australia in support of AIME
                    </p>
                  </div>
                </div>
                <div className="tile">
                  <div className="">
                    <a href="https://www.dropbox.com/s/2flcrg5q7i57bhb/AIME%20Mentoring-A%20Solution%20for%20Educational%20Inequality%20%20.pdf?dl=0">
                      <div
                        className="flex items-center video-button rounded"
                        style={{
                          backgroundImage: `url('${assetsUrl}/resources/white-paper.jpg')`,
                          backgroundSize: 'cover',
                          width: '100%'
                        }}
                      >
                  ...
                  <div className="">
                    ...
                    <p className="tile-copy">
                      This White Paper explores issues of educational inequality
                      in the U.S. and presents an evidence-based case for AIME.
                    </p>
                  </div>
                </div>
                <div className="tile">
                  <div className="">
                    <a href="https://aimementoring.com/reports/2016-annual-story">
                      <div
                        className="flex items-center video-button rounded"
                        style={{
                          backgroundImage: `url('${assetsUrl}/resources/annual-report_180219_073230.jpg')`,
                          backgroundSize: 'cover',
                          width: '100%'
                        }}
                      >
                  ...
                  <div className="">
                    ...
                    <p className="tile-copy">
                      2016 was another year of transformational education and
                      wonderful outcomes for the Indigenous kids participating
                      in AIME across Australia. It was also a year of exploring
                      new evolutionary pathways for the AIME model.
                    </p>
                  </div>
                </div>
              </div>
            ...
            <div className="">
              <div className="grid">
                <div className="baseGrid sidebar">
                  <div className="">
                    <h2 className="sidebarTitle feature-font-family">
                      More info
                    </h2>
                    ...
                    <div className="xs-p2 sm-p2 md-p4 lg-p4">
                      <span className="white center">
                        <span className="impactNew-highlight-text highlight-text highlight-text-straight white center">
                          AIME achieves the Holy Grail of educational
                          interventions
                        </span>
