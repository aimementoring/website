        ...
        <div className="vid-container">
          ...
          <div className="bgVideo-container">
            <video
              ...
              muted
              id="bgVideo"
              poster={`${assetsUrl}/assets/media/website_montage1_V001.gif`}
            >
              <source
                src={`${assetsUrl}/assets/media/website_montage1_V001.webm`}
                type="video/webm"
              />
              <source
                src={`${assetsUrl}/assets/media/website_montage1_V001.mp4`}
                type="video/mp4"
              />
            </video>
          </div>
          <div className="vid-headline flex align-items xs-py4">
            <div className="px1 center m3">
              <h1>
                <span className="pre-text center light f-24 feature-font-family">
                  Get to know
                </span>
      ...
      <div className="grid">
        <div className="baseGrid sidebar">
          ...
          <p className="f-14">
            ...
            the kids and university students we work with and the world we inhabit, we move with
            the times, we adapt and evolve constantly. Can you keep up?
          </p>
          <div className="buttons-container pt4">
            <Link to="/the-mentor/" className="ghost-btn bg-brand-primary c-white mb2">
              <span className=" download-btn-text">Read "The Mentor"</span>
            </Link>
            <Link to="/jack-manning-bancroft" className="ghost-btn bg-brand-primary c-white mb2">
              <span className=" download-btn-text">Meet Jack</span>
            </Link>
            <Link to="/impact" className="ghost-btn bg-brand-primary c-white mb2">
        ...
        <div className="baseGrid main-content">
          ...
          <div className="firstRow main-grid">
            <div className="tile tile--half">
              ...
              <p>
                ...
                provided the tools, then be able to declare that the problem we set out to solve
                is solved, for example we want to see Indigenous educational inequality ended. We
                believe every non profit should have an exit strategy and should be trying to
            ...
            <div className="tile">
              <div className="">
                ...
                <div
                  ...
                  style={{
                    backgroundImage: `url('${assetsUrl}/assets/images/know-aime/cogs.jpg')`,
              ...
              <div className="">
                ...
                <p className="tile-copy">
                  ...
                  created it in the hope it would inspire others to join us in changing the way
                  the world works. It’s since won a Webby award and been viewed 20 million times
          ...
          <div className="secondRow main-grid">
            <div className="single-tile">
              <div className="single-tile-video">
                ...
                <p>
                  As a headline. This is not a one-on-one mentoring model. The program is guided
                  by a curriculum and all of our workshops happen on both the university and high
                  school campuses with groups of university students and high school kids
                  together, with a lead AIME mentor helping facilitate the delivery of the
                  content.
                </p>

                <p>
                  The program is structured, has a start and end point, as we believe our role is
                  to be mentors and not saviours. That the ultimate success is the kids not
                  wanting to be in the program any more because they are stronger without us.
                  There is no contact outside of our programmed workshops.
                </p>
            ...
            <div className="tile">
              <div className="">
                ...
                <div
                  className="flex items-center video-button rounded"
                  style={{
                    backgroundImage: `url('${assetsUrl}/assets/images/know-aime/tutor-squad-thumb.jpg')`,
                    backgroundSize: 'cover',
                    width: '100%',
                  }}
                >
            ...
            <div className="tile">
              <div className="">
                ...
                <div
                  className="flex items-center video-button rounded"
                  style={{
                    backgroundImage: `url('${assetsUrl}/assets/images/know-aime/tutorsquads.jpg')`,
                    backgroundSize: 'cover',
                    width: '100%',
                  }}
                >
              ...
              <div className="">
                ...
                <p className="tile-copy">
                  A look inside an actual AIME tutor squad at St Scholastica's College in Glebe,
            ...
            <div className="single-tile">
              <div className="single-tile-video">
                ...
                <ul>
                  ...
                  <li>
                    Got a book called The Mentor of which the proceeds raised fund our work
                    globally
                  </li>
                </ul>
              ...
              <div className="tile">
                <div className="">
                  <a target="_blank" rel="noopener noreferrer" href="https://www.youtube.com/embed/Mt5RxdQRFR4">
                    <div
                      className="flex items-center video-button rounded"
                      style={{
                        backgroundImage: `url('${assetsUrl}/assets/images/know-aime/australian-story.jpg')`,
                        backgroundSize: 'cover',
                        width: '100%',
                      }}
                    >
                ...
                <div className="">
                  ...
                  <p className="tile-copy">
                    30-minute life story piece about AIME's founder Jack Manning Bancroft from
                    2012
                  </p>
                </div>
              </div>
          ...
          <div className="firstRow main-grid">
            <div className="tile tile--half">
              <p>
                In a simple sentence, we are looking to take the model back to where it started
                with our founder, a volunteer model led by university students to mentor high
                school kids. And as an organisation we are working round the clock to make the
                tools that will simplify the process for the university across the globe running
                AIME.
              </p>
              <p>
                ...
                disadvantaged kids in one go. On the 2019 plane, 200 uni students from different
                US campuses and coming from disadvantaged backgrounds, will be flown alongside
                world class leaders, storytellers and performers, to be trained and inspired at
                the world's first ever
                {' '}
                <stong>Festival of Mentoring</stong>
. On return each of
                them will launch AIME in their campuses and aim to mobilise 100 mentors to work
                with 100 disadvantaged school kids.
              </p>
            </div>
            <div className="tile">
              <div className="">
                ...
                <div
                  className="flex items-center video-button rounded"
                  style={{
                    backgroundImage: `url('${assetsUrl}/assets/images/know-aime/welcome.jpg')`,
                    backgroundSize: 'cover',
                    width: '100%',
                  }}
                >
            ...
            <div className="tile">
              <div className="">
                ...
                <div
                  className="flex items-center video-button rounded"
                  style={{
                    backgroundImage: `url('${assetsUrl}/assets/images/know-aime/schools-thumb.jpg')`,
                    backgroundSize: 'cover',
                    width: '100%',
                  }}
                >
            ...
            <div className="tile">
              <div className="">
                ...
                <div
                  className="flex items-center video-button rounded"
                  style={{
                    backgroundImage: `url('${assetsUrl}/assets/images/know-aime/program-day.jpg')`,
                    backgroundSize: 'cover',
                    width: '100%',
                  }}
                >
            ...
            <div className="tile">
              <div className="">
                ...
                <div
                  className="flex items-center video-button rounded"
                  style={{
                    backgroundImage: `url('${assetsUrl}/assets/images/know-aime/recruit.jpg')`,
                    backgroundSize: 'cover',
                    width: '100%',
                  }}
                >
            ...
            <div className="tile">
              <div className="">
                ...
                <div
                  className="flex items-center video-button rounded"
                  style={{
                    backgroundImage: `url('${assetsUrl}/assets/images/know-aime/anthem.jpg')`,
                    backgroundSize: 'cover',
                    width: '100%',
                  }}
                >
          ...
          <div className="forthRow main-grid">
            <div className="tile">
              <div className="">
                <Link to="/story/the-backdrop-to-aime/">
                  <div
                    className="lex items-center image-button rounded"
                    style={{
                      backgroundImage: `url('${assetsUrl}/assets/images/banner/backdrop.jpg')`,
                      backgroundSize: 'cover',
                      width: '100%',
                    }}
                  >
                    <img
                      ...
                      className="center mx-auto"
                      style={{ width: '50px' }}
                      src={`${assetsUrl}/assets/images/link.svg`}
                    />
                  </div>
                </Link>
              </div>
              ...
              <div className="">
                <a href="https://shop.aimementoring.com/collections/best-books-eva/products/the-mentor">
                  <div
                    ...
                    style={{
                      backgroundImage: `url('${assetsUrl}/assets/images/know-aime/thementor.jpg')`,
                      backgroundSize: 'cover',
                      width: '100%',
                    }}
                  >
                    <img
                      ...
                      className="center mx-auto"
                      style={{ width: '50px' }}
                      src={`${assetsUrl}/assets/images/shopping-cart.svg`}
                    />
                  </div>
                </a>
              </div>
            ...
            <div className="tile">
              <div className="">
                <a href="https://shop.aimementoring.com/products/mentoring-the-key-to-a-fairer-world">
                  <div
                    className="flex image-button items-center rounded"
                    style={{
                      backgroundImage: `url('${assetsUrl}/assets/images/know-aime/mentoring.jpg')`,
                      backgroundSize: 'cover',
                      width: '100%',
                    }}
                  >
              ...
              <div className="">
                ...
                <p className="tile-copy">
                  ...
                  bravery, imagination, daring, hard work and a belief that change is possible if
                  we work together, if we dream big and if we don't take 'no' for an answer.
                  {' '}
                </p>
              </div>
            </div>
            <div className="tile">
              <div className="">
                <Link to="/global-letter">
                  <div
                    className="flex image-button items-center rounded"
                    style={{
                      backgroundImage: `url('${assetsUrl}/assets/images/know-aime/letter.jpg')`,
                      backgroundSize: 'cover',
                      width: '100%',
                    }}
                  >
              ...
              <div className="">
                ...
                <p className="tile-copy">
                  It’s not every day that an idea that can change the world comes across your
                  desk.
                </p>
              </div>
            </div>
              ...
              <div className="">
                ...
                >
                  <div
                    className="flex image-button items-center rounded"
                    style={{
                      backgroundImage: `url('${assetsUrl}/assets/images/know-aime/no-shame.jpg')`,
                      backgroundSize: 'cover',
                      width: '100%',
                    }}
                  >
                    <img
                      ...
                      className="center mx-auto"
                      style={{ width: '50px' }}
                      src={`${assetsUrl}/assets/images/Download.svg`}
                    />
                  </div>
                </a>
              </div>
              ...
              <div className="">
                ...
                >
                  <div
                    className="flex image-button items-center rounded"
                    style={{
                      backgroundImage: `url('${assetsUrl}/assets/images/know-aime/white-paper.jpg')`,
                      backgroundSize: 'cover',
                      width: '100%',
                    }}
                  >
