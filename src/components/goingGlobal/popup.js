  ...
  const renderModule1 = () => (
    <>
      <div className={styles.module2017}>
        ...
        <a href="/" className={styles.nextLink}>CHECK OUT 2018 -></a>
      </div>
    </>
  );
  ...
  const renderModule2 = () => (
    <>
      <div className={styles.module2018}>
        ...
        <a href="/" className={styles.nextLink}>CHECK OUT 2019 -></a>
      </div>
    </>
  );
  const renderModule3 = () => (
    <>
      <div className={styles.module2019}>
        ...
        <a href="/" className={styles.nextLink}>CHECK OUT WHAT WE’VE ACCOMPLISHED</a>
      </div>
    </>
  );
