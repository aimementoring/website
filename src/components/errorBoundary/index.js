              ...
              <div className="justify-center items-center sm-flex">
                <div>
                  ...
                  <p className="f-14 light pt2 c-white">
                    Sorry for any inconvenience. If you're seeing this often, please <Link to="/contact"> contact us </Link>
                  </p>
                  <Link to="/" className="basic-btn bold bg-brand-primary c-white mt3">Back to home</Link>
                </div>
              </div>
            </div>
          </div>
