              ...
              return (
                <li className="py2" onClick={this.handleTalentItemClicked(item)} key={item}>
                  {`#${item.toLowerCase()}` === this.props.hash
                    ? <Link className="text-decoration-none f-18 feature-font-family c-white active" to="/">{headerItem}</Link>
                    : <Link className="text-decoration-none f-18 feature-font-family c-white" to="/">{headerItem}</Link>}
                </li>
              )
            })}
            <li className="py2" onClick={this.handleTalentItemClicked('register')}>
              {`#register` === this.props.hash
                ? <Link className="text-decoration-none f-18 feature-font-family c-white active" to="/">Register</Link>
                : <Link className="text-decoration-none f-18 feature-font-family c-white" to="/">Register</Link>}
            </li>
          </ul>
        </nav>
      </React.Fragment>
